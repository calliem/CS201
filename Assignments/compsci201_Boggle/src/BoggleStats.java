...
public class BoggleStats {
   ...
   // ArrayList<String> boardList = new ArrayList<String>();
    ...
    public void doTests(ILexicon lex){
      ...
      //  ArrayList<Integer> newScores = new ArrayList<Integer>(myLexiconScores);
     //   Collections.sort(newScores);
    //    int maxKey = newScores.get(newScores.size()-1);
      //  System.out.println(boardList.get(myLexiconScores.indexOf(maxKey)));
    }
